...
1. **Has the overall facial balance shifted?** — Proportions, symmetry, and convexity change before individual wrinkles become prominent.

2. **Where is the deflation or descent originating?** — The midface, jawline, temple, and periorbital areas age at different rates and through different mechanisms.

3. **Is this a texture problem, a structural problem, or both?** — Surface quality (texture, tone, fine lines) and structural integrity (volume, support, position) require fundamentally different interventions.
