...
1. **Protocols that chase dramatic single-session results.** High fluence = higher PIH risk.
2. **Melasma being treated aggressively.** It should be handled with restraint, not force.
3. **A promise that pico fractional will fix deep scars.** It won't — ask about ablative or combination options instead.
4. **No mention of a series.** Pore and texture results build over time; one session is not a plan.
5. **No discussion of combinations.** For acne scars especially, combination protocols consistently outperform pico alone.
