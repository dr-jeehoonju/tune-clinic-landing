...
1. The cell membrane invaginates to form an **early endosome**
2. Intraluminal vesicles (ILVs) accumulate inside the **multivesicular body (MVB)**
3. The MVB fuses with the cell membrane, releasing exosomes into the extracellular space
4. Exosomes bind to receptors on target cells, release their cargo, and **alter gene expression**
