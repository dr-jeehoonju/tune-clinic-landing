...
- **Produktvielfalt** — Es gibt nicht mehr "den einen" Filler. Ärztinnen und Ärzte wählen heute aus einer Reihe rheologischer Profile (Festigkeit, Verteilung, Lift-Kapazität), je nachdem, ob das Ziel tiefe strukturelle Abstützung, oberflächliche Hydratation oder Konturverfeinerung ist.
- **Injektionstechnik** — Kanülengestützte Platzierung, Mikro-Bolus-Layering und retrogrades Threading haben den früheren Ansatz, große Mengen in einer einzigen Schicht zu injizieren, abgelöst.
- **Ärztliches Urteil** — Eine gut ausgebildete Ärztin füllt nicht einfach auf. Sie beurteilt Bänderlaxität, Knochenresorption und die Qualität des Weichgewebes, bevor sie entscheidet, ob Filler überhaupt das richtige Mittel ist.
