...
1. **Hat sich die gesamte Gesichtsbalance verschoben?** — Proportionen, Symmetrie und Konvexität verändern sich, bevor einzelne Falten prominent werden.

2. **Woher stammt die Deflation oder der Abstieg?** — Das Mittelgesicht, die Kieferlinie, die Schläfe und die periorbitale Region altern in unterschiedlichem Tempo und über unterschiedliche Mechanismen.

3. **Ist das ein Textur-, ein Struktur- oder ein beiderseitiges Problem?** — Oberflächenqualität (Textur, Ton, feine Linien) und strukturelle Integrität (Volumen, Abstützung, Position) erfordern grundlegend unterschiedliche Interventionen.
